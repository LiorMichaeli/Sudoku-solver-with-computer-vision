...
INDEX_OF_IMG_PATH_ARG_IN_ARGS_LIST = 0
INDEX_OF_INITIALIZED_NUMBERS_IN_SUDOKU_BY_ORDER_ARG_IN_ARGS_LIST = 1
INDEX_OF_DO_RECURSIVE_DRAWING_ARG_IN_ARGS_LIST = 2
WINDOW_SIZE = 540
